# -*- encoding: utf-8 -*-
# stub: arborist-webservice 0.0.1.pre20180815100446 ruby lib

Gem::Specification.new do |s|
  s.name = "arborist-webservice".freeze
  s.version = "0.0.1.pre20180815100446"
  ...
  s.files = [".document".freeze, ".editorconfig".freeze, ".rdoc_options".freeze, ".simplecov".freeze, "ChangeLog".freeze, "History.md".freeze, "Manifest.txt".freeze, "README.md".freeze, "Rakefile".freeze, "lib/arborist/monitor/webservice.rb".freeze, "lib/arborist/node/webservice.rb".freeze, "lib/arborist/webservice.rb".freeze, "spec/arborist/node/webservice_spec.rb".freeze, "spec/spec_helper.rb".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<arborist>.freeze, ["~> 0"])
      ...
      s.add_dependency(%q<arborist>.freeze, ["~> 0"])
