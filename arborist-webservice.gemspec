...
Gem::Specification.new do |s|
  ...
  s.files = [".document".freeze, ".editorconfig".freeze, ".rdoc_options".freeze, ".simplecov".freeze, "ChangeLog".freeze, "History.md".freeze, "Manifest.txt".freeze, "README.md".freeze, "Rakefile".freeze, "lib/arborist/monitor/webservice.rb".freeze, "lib/arborist/node/webservice.rb".freeze, "lib/arborist/webservice.rb".freeze, "lib/arborist/webservice/constants.rb".freeze, "spec/arborist/monitor/webservice_spec.rb".freeze, "spec/arborist/node/webservice_spec.rb".freeze, "spec/arborist/webservice_spec.rb".freeze, "spec/spec_helper.rb".freeze]
  s.homepage = "http://deveiate.org/projects/arborist-webservice".freeze
  s.licenses = ["BSD-3-Clause".freeze]
  s.rdoc_options = ["--main".freeze, "README.md".freeze]
  s.rubygems_version = "2.7.6".freeze
  s.summary = "This is a collection of webservice monitoring tools for the Arborist monitoring toolkit (http://arbori.st/)".freeze

  if s.respond_to? :specification_version then
    s.specification_version = 4

    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<arborist>.freeze, ["~> 0.2"])
      ...
      s.add_dependency(%q<arborist>.freeze, ["~> 0.2"])
